...
#define SS_START	  (UNI_SS->CON |= BIT(1))
#define SS_EN_ISR     (UNI_SS->CON |= BIT(2))
#define D_PND_CLR	  (UNI_SS->CON |= BIT(3))
#define D_PND         (UNI_SS->CON &  BIT(4))
#define I_PND_CLR     (UNI_SS->CON |= BIT(5))
#define I_PND         (UNI_SS->CON &  BIT(6))
#define ERR_CLR       (UNI_SS->CON |= BIT(7))
#define CSB_PND_CLR   (UNI_SS->DMA_CON |= BIT(13))
#define CSB_PND       (UNI_SS->DMA_CON & BIT(14))


#define IS_PND        (UNI_SS->IO_CON & BIT(17))
#define IS_PND_CLR    (UNI_SS->IO_CON | BIT(16))
#define ET_PND        (UNI_SS->IO_CON & BIT(19))
#define ET_PND_CLR    (UNI_SS->IO_CON | BIT(18))


#define USING_BUF_INDEX       (UNI_SS->CON & BIT(12))
#define USING_INF_BUF_INDEX   (UNI_SS->CON & BIT(13))
#define ERROR_VALUE           ((UNI_SS->CON &(BIT(8)|BIT(9)|BIT(10)|BIT(11)))>>8)
