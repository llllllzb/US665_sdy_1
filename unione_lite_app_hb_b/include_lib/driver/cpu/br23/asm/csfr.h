...
// } UNI_CMNG_TypeDef;
//
// #define UNI_CMNG_BASE                   (csfr_base + map_adr(0x00, 0x00))
// #define UNI_CMNG                        ((UNI_CMNG_TypeDef *)UNI_CMNG_BASE)
...
#define UNI_SDTAP_BASE                  (csfr_base + map_adr(0x01, 0x00))
#define UNI_SDTAP                       ((UNI_SDTAP_TypeDef *)UNI_SDTAP_BASE)
...
#define UNI_MBIS_BASE                   (csfr_base + map_adr(0x02, 0x00))
#define UNI_MBIS                        ((UNI_MBIS_TypeDef *)UNI_MBIS_BASE)
...
typedef struct {
    ...
    short vld: 1;
    short reserved: 2;
} UNI_MMU_TLB1_TypeDef;

#define UNI_MMU_TLB1                  ((UNI_MMU_TLB1_TypeDef *)(UNI_MMU->TLB1_BEG)) */
...
#define UNI_MMU_BASE                  (csfr_base + map_adr(0x03, 0x00))
#define UNI_MMU                       ((UNI_MMU_TypeDef *)UNI_MMU_BASE)
...
#define UNI_DSP_BASE                   (csfr_base + map_adr(0x10, 0x00))
#define UNI_DSP                        ((UNI_DSP_TypeDef*)UNI_DSP_BASE)
...
#define UNI_DEBUG_BASE                 (csfr_base + map_adr(0x10, 0x10))
#define UNI_DEBUG                      ((UNI_DEBUG_TypeDef *)UNI_DEBUG_BASE)
...
#define UNI_FFT_BASE                  (csfr_base + map_adr(0x20, 0x00))
#define UNI_FFT                       ((UNI_FFT_TypeDef *)UNI_FFT_BASE)
...
#define q32DSP(n)          ((UNI_TypeDef_q32DSP     *)(q32DSP_sfr_base + q32DSP_sfr_offset*n))
#define q32DSP_mpu(n)      ((UNI_TypeDef_q32DSP_MPU *)(q32DSP_mpu_base + q32DSP_sfr_offset*n))
