...
#if 0
#define     IO_DEBUG_0(i,x)       {UNI_PORT##i->DIR &= ~BIT(x), UNI_PORT##i->OUT &= ~BIT(x);}
#define     IO_DEBUG_1(i,x)       {UNI_PORT##i->DIR &= ~BIT(x), UNI_PORT##i->OUT |= BIT(x);}
#define     IO_DEBUG_TOGGLE(i,x)  {UNI_PORT##i->DIR &= ~BIT(x), UNI_PORT##i->OUT ^= BIT(x);}
