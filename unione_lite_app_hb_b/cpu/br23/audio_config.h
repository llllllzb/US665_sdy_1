 ...
 * @brief 最小音量值
 */
#define USER_AUDIO_VOL_MIN 1
/**
 * @brief 最大音量值
 */
#define USER_AUDIO_VOL_MAX (get_max_sys_vol())
/**
 * @brief 中等音量值
 */
#define USER_AUDIO_VOL_MID (((USER_AUDIO_VOL_MIN) + (USER_AUDIO_VOL_MAX)) / 2)
/**
 * @brief 默认音量值
 */
#define USER_AUDIO_VOL_DEFAULT 20
/** @}*/
