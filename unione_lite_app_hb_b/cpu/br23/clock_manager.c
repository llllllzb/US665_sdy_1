...
#if 1  //unified clk to 240MHZ
const struct clock_type  clock_enum[] = {

    { BT_IDLE_CLOCK     	, (240), "	BT_IDLE_CLOCK      " },
    { MUSIC_IDLE_CLOCK  	, (240), "	MUSIC_IDLE_CLOCK   " },
    { FM_IDLE_CLOCK     	, (240), "	FM_IDLE_CLOCK      " },
    { LINEIN_IDLE_CLOCK 	, (240), "	LINEIN_IDLE_CLOCK  " },
    { PC_IDLE_CLOCK     	, (240), "	PC_IDLE_CLOCK      " },
    { REC_IDLE_CLOCK    	, (240), "	REC_IDLE_CLOCK     " },
    { RTC_IDLE_CLOCK    	, (240), "	RTC_IDLE_CLOCK     " },
    { SPDIF_IDLE_CLOCK  	, (240), "	SPDIF_IDLE_CLOCK   " },
    { BOX_IDLE_CLOCK  		, (240), "	BOX_IDLE_CLOCK   " },
    /**************************************************************************/

    { DEC_SBC_CLK	, (240), "DEC_SBC_CLK	 " },
    { DEC_AAC_CLK	, (240), "DEC_AAC_CLK	 " },
    { DEC_MSBC_CLK	, (240), "DEC_MSBC_CLK	 " },
    { DEC_CVSD_CLK	, (240), "DEC_CVSD_CLK	 " },

    { AEC8K_CLK	, (240), "AEC8K_CLK	     " },
    { AEC8K_ADV_CLK	, (240), "AEC8K_ADV_CLK	 " },
    { AEC16K_CLK	, (240), "AEC16K_CLK	 " },
    { AEC16K_ADV_CLK, (240), "AEC16K_ADV_CLK " },

    { DEC_TONE_CLK	, (240), "DEC_TONE_CLK	 " },
    { DEC_MP3_CLK	, (240), "DEC_MP3_CLK	 " },
    { DEC_WAV_CLK	, (240), "DEC_WAV_CLK	 " },
    { DEC_G729_CLK	, (240), "DEC_G729_CLK	 " },
    { DEC_G726_CLK	, (240), "DEC_G726_CLK	 " },
    { DEC_PCM_CLK	, (240), "DEC_PCM_CLK	 " },
    { DEC_MTY_CLK	, (240), "DEC_MTY_CLK	 " },
    { DEC_WMA_CLK	, (240), "DEC_WMA_CLK	 " },

    { DEC_APE_CLK	, (240), "DEC_APE_CLK	 "},
    { DEC_FLAC_CLK	, (240), "DEC_FLAC_CLK	 "},
    { DEC_AMR_CLK	, (240), "DEC_AMR_CLK	 "},
    { DEC_DTS_CLK	, (240), "DEC_DTS_CLK	 " },

    { DEC_M4A_CLK	, (240), "DEC_M4A_CLK	 "},
    { DEC_ALAC_CLK	, (240), "DEC_ALAC_CLK	 "},
    { DEC_FM_CLK	, (240), "DEC_FM_CLK	 " },
    { DEC_LINE_CLK	, (240), "DEC_LINE_CLK	 " },
    { DEC_TWS_SBC_CLK, (240), "DEC_TWS_SBC_CLK" },
    { SPDIF_CLK		, (240), "SPDIF_CLK	     " },

    { ENC_RECODE_CLK, (240), "ENC_RECODE_CLK "  },
    { ENC_SBC_CLK	, (240), "ENC_SBC_CLK	 "  },
    { ENC_WAV_CLK	, (240), "ENC_WAV_CLK	 "  },
    { ENC_G726_CLK, (240), "ENC_G726_CLK   "  },
    { ENC_MP3_CLK	, (240), "ENC_MP3_CLK	 "  },
    { ENC_TWS_SBC_CLK, (240), "ENC_TWS_SBC_CLK" },
    { ENC_MSBC_CLK	, (240), "ENC_MSBC_CLK	 "  },
    { ENC_CVSD_CLK	, (240), "ENC_CVSD_CLK	 "  },

    { SYNC_CLK	, (240), "SYNC_CLK	     "  },
    { AUTOMUTE_CLK	, (240), "AUTOMUTE_CLK" },

    { FINDF_CLK	, (240), "FINDF_CLK	     "  },
    { FM_INSIDE_CLK	, (240), "FM_INSIDE_CLK	 " },
#if TCFG_DEC2TWS_ENABLE
    { BT_CONN_CLK	, (240), "BT_CONN_CLK	 " },
#else
    { BT_CONN_CLK	, (240), "BT_CONN_CLK	 " },
#endif
    ...
    { EQ_CLK	, (240), " EQ_CLK	     "   },
    { EQ_DRC_CLK	, (240), " EQ_DRC_CLK	 "   },
    //{ EQ_ONLINE_CLK, (240), " EQ_ONLINE_CLK "   },
    { REVERB_CLK	, (240), " REVERB_CLK	 "   },
    { REVERB_HOWLING_CLK	, (240), " REVERB_HOWLING_CLK	 "   },
    { REVERB_PITCH_CLK	, (240), " REVERB_PITCH_CLK	 "   },

    { DEC_MP3PICK_CLK,	(240), 	"DEC_MP3PICK_CLK"   },
    { DEC_WMAPICK_CLK,	(240),	"DEC_WMAICK_CLK"   },
    { DEC_M4APICK_CLK,	(240),	"DEC_M4AICK_CLK"   },
    { DEC_MIX_CLK, (240),	"DEC_MIX_CLK"   },

    { DEC_IIS_CLK, (240),	"DEC_IIS_CLK"   },
    { DEC_UI_CLK, (240),	"DEC_UI_CLK"   },

    /* { DEC_MIDI_CLK, (240),	"DEC_MIDI_CLK"   }, */
    //midi音色文件跳转读取频繁，外挂flash baud 调到6000000L, midi_clk 80M就够
    { DEC_MIDI_CLK, (240),	"DEC_MIDI_CLK"   },
    /* { DEC_MIDI_CLK, (240),	"DEC_MIDI_CLK"   }, */

    { CHARGE_BOX_CLK, (240),	"CHARGE_BOX_CLK"   },

    { DEC_3D_CLK, (240),	"DEC_3D_CLK"   },
    { DEC_VBASS_CLK, (240),	"DEC_VBASS_CLK"   },
    { DEC_LOUDNES_CLK, (240),	"DEC_LOUDNES_CLK"},

    { LCD_UI_CLK, (240),	"LCD_UI_CLK"   },

    { SCAN_DISK_CLK, (240),	"SCAN_DISK_CLK"   },//提高扫盘速度

#if TCFG_DEC2TWS_ENABLE
    { LOCALTWS_CLK, (240), "LOCALTWS_CLK"  },
#endif
    {SPECTRUM_CLK, (240),	"SPECTRUM_CLK"   },

    {AI_SPEECH_CLK, (240),	"AI_SPEECH_CLK"   },
    {SMARTBOX_ACTION_CLK, (240),	"SMARTBOX_ACTION_CLK"   },
};
#else
const struct clock_type  clock_enum[] = {
