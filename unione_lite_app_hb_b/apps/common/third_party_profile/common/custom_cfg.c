...
#define VM_API_US662P2	0
#define VM_API_US663P1	1
#define USE_VM_API_SEL VM_API_US663P1
...
#define SDFILE_API_US662P2	0
#define SDFILE_API_US663P1	1
#define USE_FS_API_SEL		SDFILE_API_US663P1
...
#if (USE_VM_API_SEL == VM_API_US662P2)
#include "flash_api.h"
#elif (USE_VM_API_SEL == VM_API_US663P1)
...
#if (USE_FS_API_SEL == SDFILE_API_US662P2)
...
#elif (USE_FS_API_SEL == SDFILE_API_US663P1)
    FILE *fp = NULL;
