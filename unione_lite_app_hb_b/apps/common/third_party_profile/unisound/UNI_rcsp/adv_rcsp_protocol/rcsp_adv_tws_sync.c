...
{
    UNI_rcsp_event_to_user(DEVICE_EVENT_FROM_RCSP, MSG_UNI_FIND_DEVICE_RESUME, &args, sizeof(args));
}
...
{
    UNI_rcsp_event_to_user(DEVICE_EVENT_FROM_RCSP, MSG_UNI_FIND_DEVICE_STOP, &args, sizeof(args));
}
