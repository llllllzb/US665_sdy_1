...
#define EIR_TAG_STRING   0xd6, 0x05, 0x08, 0x00, 'U', 'S', 'A', 'I', 'S', 'D','K'
...
static char gap_device_name[BT_NAME_LEN_MAX] = "uni_ble_test";
...
#define EXT_ADV_NAME                    'U', 'S', '_', 'E', 'X', 'T', '_', 'A', 'D', 'V'
/* #define EXT_ADV_NAME                    "UNI_EXT_ADV" */
