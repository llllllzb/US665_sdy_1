...
#ifdef CONFIG_BOARD_US665P3_DEMO
...
STATUS_CONFIG status_config = {
    ...
    .tone = {
        ...
        .power_on      = IDEX_TONE_NONE,
        .power_off     = IDEX_TONE_NONE,
        .lowpower      = IDEX_TONE_NONE,
        .max_vol       = IDEX_TONE_NONE,
        .phone_in      = IDEX_TONE_NONE,
        .phone_out     = IDEX_TONE_NONE,
        .phone_activ   = IDEX_TONE_NONE,
        .bt_init_ok    = IDEX_TONE_NONE,
        .bt_connect_ok = IDEX_TONE_NONE,
        .bt_disconnect = IDEX_TONE_NONE,
        .tws_connect_ok   = IDEX_TONE_NONE,
...
#define     APP_IO_DEBUG_0(i,x)       //{UNI_PORT##i->DIR &= ~BIT(x), UNI_PORT##i->OUT &= ~BIT(x);}
#define     APP_IO_DEBUG_1(i,x)       //{UNI_PORT##i->DIR &= ~BIT(x), UNI_PORT##i->OUT |= BIT(x);}
