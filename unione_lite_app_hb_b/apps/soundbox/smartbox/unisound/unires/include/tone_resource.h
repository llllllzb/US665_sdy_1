...
static const char *const tone_index[] = {
    ...
    [IDEX_TONE_NUM_103] = SDFILE_RES_ROOT_PATH"tone/103.*",
    [IDEX_TONE_NUM_104] = SDFILE_RES_ROOT_PATH"tone/104.*",
    [IDEX_TONE_NUM_105] = SDFILE_RES_ROOT_PATH"tone/105.*",
    [IDEX_TONE_NUM_106] = SDFILE_RES_ROOT_PATH"tone/106.*",
    [IDEX_TONE_NUM_107] = SDFILE_RES_ROOT_PATH"tone/107.*",
};
...
static const tone_map_t tone_mapping[] = {
    ...
    {IDEX_TONE_NUM_103, 103},
    {IDEX_TONE_NUM_104, 104},
    {IDEX_TONE_NUM_105, 105},
    {IDEX_TONE_NUM_106, 106},
    {IDEX_TONE_NUM_107, 107},
};
