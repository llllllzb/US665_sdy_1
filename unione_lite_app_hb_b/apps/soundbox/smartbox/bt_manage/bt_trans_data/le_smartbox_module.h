...
#define UNI_OPCODE_SET_ADV 							    0xC0
#define	UNI_OPCODE_GET_ADV  								0xC1
#define UNI_OPCODE_ADV_DEVICE_NOTIFY 					0xC2
#define UNI_OPCODE_ADV_NOTIFY_SETTING 					0xC3
#define UNI_OPCODE_ADV_DEVICE_REQUEST					0xC4
