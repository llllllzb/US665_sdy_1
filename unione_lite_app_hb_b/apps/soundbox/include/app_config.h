...
#define STYLE_UNI_WTACH              (1)//彩屏demo
#define STYLE_UNI_SOUNDBOX           (2)//点阵屏demo
#define STYLE_UNI_CHARGE             (3)//点阵屏充电仓
#define STYLE_UNI_LED7               (4)//led7
...
#define REC_FOLDER_NAME				"UNI_REC"
