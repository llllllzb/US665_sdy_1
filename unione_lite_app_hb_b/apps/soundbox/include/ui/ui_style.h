...
#define CONFIG_UI_STYLE_UNI_ENABLE
#endif



#if(CONFIG_UI_STYLE == STYLE_UNI_SOUNDBOX)
#include "ui/style_uni02.h"//点阵//
...
#if(CONFIG_UI_STYLE == STYLE_UNI_LED7)//led7 显示
